...
const rawCode = (strings, ...values) => {
	const code = String.raw(strings, ...values).replace(/[<>$&{}[\]]/g, (m) => `&#${m.codePointAt(0)};`);
	/** @type {any} */
	const templateStringArray = [code];
	templateStringArray.raw = [code];
	return html(templateStringArray);
};

export class NetspeakDeveloper extends NetspeakElement {
	static get importMeta() { return import.meta; }
	static get is() { return 'netspeak-developer'; }
