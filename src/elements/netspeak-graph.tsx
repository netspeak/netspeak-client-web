...
const NetspeakGraph = (props: NetspeakGraphProps): JSX.Element => {
	...
	const setSelectedWords = (selection: { element: GraphElement; id: string }[]): void => {
	...
	const generateGraphNodes = async (): Promise<NetspeakGraphColumn[] | undefined> => {
		if (query === "") {
			return;
		}
	...
	// * Render page
	// let graphColumns = useAsync(generateGraphNodes, [props.pageQuerry, frequencyRange]).res ?? []
